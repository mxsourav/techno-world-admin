...
export default function SalesReportWorkspace() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-white/[0.08] dark:bg-[#0f172a]">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-extrabold text-slate-900 dark:text-white">Sales & Revenue Reports</h2>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            disabled={refreshing}
            className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 disabled:opacity-50 transition-colors dark:border-white/10 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-emerald-700 px-4 py-2 text-xs font-bold text-white shadow-sm hover:bg-emerald-800 disabled:opacity-50 transition-colors"
          >
            <Download className="h-3.5 w-3.5" />
            {exporting ? 'Exporting...' : 'Export for Tally (CSV)'}
          </button>
        </div>
      </div>

      {/* Period Filter Bar */}
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white p-3 shadow-sm dark:border-white/[0.08] dark:bg-[#0f172a]">
        <div className="flex flex-wrap items-center gap-1.5">
          <span className="flex items-center gap-1 px-2 text-xs font-bold text-slate-500 uppercase tracking-wider dark:text-slate-400">
